...
import { Inicio, Faq, Error404, Team, Testimonials, Trips, Intro, Signup, Login } from './pages'
import { Home, TextsEdit, LatestVideos } from './pages/dashboard'
import { ProtectedRoute } from './components/ProtectedRoute/ProtectedRoute'
import { TextsContext } from './context/Dashboard/Texts'

export const AppRoutes = () => {
	const { getTextByLanguage, text } = useContext(TextsContext)
	useEffect(() => {
		if(!text || !text._id || text._id === '' ) {
			getTextByLanguage()
		}
	}, [text])
