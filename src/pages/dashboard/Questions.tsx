...
export const Questions = () => {
	...
	const [showModalQuestions, setShowModalQuestions] =
		useState<IModalQuestionOptions>({
			open: false,
			action: null,
			data: undefined,
		})
	...
	const handleDeleteQuestion = () => {
		const newQuestions = text?.questions.filter(
			(el) => !(el.title === showDeleteModal.data?.title)
		)
	...
	return (
		<>
			<QuestionModal
				...
				onClose={() =>
					setShowModalQuestions({ open: false, data: undefined, action: null })
				}
				onSave={handleSave}
										...
										<TableRow key={question?.title}>
											...
											<StyledTableCell sx={{ textAlign: 'center' }}>
												...
												<Button
													...
													onClick={() => {
														setShowDeleteModal({ open: true, data: question })
													}}
												>
